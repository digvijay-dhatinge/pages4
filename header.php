    ...
    <!-- Main Header-->
	<header class="boxcar-header header-style-v9">
        <div class="header-inner">
            <div class="inner-container">
                ...
                <div class="c-box">
                      ...
                      <div class="nav-out-bar">    
                        <nav class="nav main-menu">
                            <ul class="navigation" id="navbar">
                                ...
                                <li class="current-dropdown"><span>Pages <i class="fa-solid fa-angle-down"></i></span>
                                    <ul class="dropdown">
                    ...
                    <!-- Main Menu End-->
                    <div class="logo st-logo">
                        <a href="index-2.html"><img src="images/logo.svg" alt="" title="Boxcar"></a>
                    </div>
                    <div class="right-box">
